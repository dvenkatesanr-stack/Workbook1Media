...
const galleryData = {
  ...
  7: [
    ...
    { media: 'Run3', caption: 'Trial Run 3', text: 'In the final trial run, we decided to shift the concept from a helmet-based system to a walking stick format. This change made the device more practical and safer to use, allowing it to better detect obstacles at ground level while guiding movement more effectively. The walking stick setup improved reliability in identifying obstacles and provided a more intuitive way for the user to navigate their environment.' },
  ],
  8: [
