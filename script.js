...
const galleryData = {
  ...
  9: [
    ...
    { media: 'research2.png', caption: 'Electronic Art', text: 'This project is “Electronic Art” app by ilvyanyatka. It generates geometric shapes based on parameters read from an Arduino, and the user can interact with switches and buttons to modify those parameters and change what is being drawn on the screen. What I find interesting is how simple inputs from Arduino translate into complex visual outputs. The interaction is quite direct, but it produces visuals that feel dynamic and responsive, depending on how the user adjusts the controls.', link:'https://community.element14.com/challenges-projects/project14/electronicart/b/blog/posts/electronic-art-app-controlled-by-arduino-uno' },
    { media: 'research3.png', caption: 'Audience', text: '“Audience” by Random International is a motion-tracking installation where multiple units turn to follow a person’s position. I like its simplicity and how it subtly reflects audience behaviour in galleries, where people constantly orient themselves toward what they’re viewing. While each unit is simple, the large-scale repetition creates a strong immersive effect that feels slightly unsettling. Overall, it made me think about how interaction can be embedded into the environment itself, so the audience becomes part of the system rather than just observers.', link:'https://www.youtube.com/watch?v=JuKi35j3Dwk'  },
    { media: 'research4.png', caption: 'Land Lines', text: '“Land Lines” by Zach Lieberman is an interactive work where users draw a line and the system finds a real-world location with a similar shape. I find it interesting for how it connects simple drawing interactions with real geographic forms, creating a link between user input and the natural world. Although the mechanism is simple, the experience feels playful, engaging, and subtly educational.It demonstrates how creative coding can turn basic inputs like drawing into meaningful and immersive interactions.', link:'https://lines.chromeexperiments.com/'  },
